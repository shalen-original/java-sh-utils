 ...
 * 
 * @param <T> The type of data to be represented
 */
public class ScatterPlot2D <T extends Number> {
	 ...
	 * @param title The title of the new scatter plot.
	 */
	 ...
	 * Create a new 2D scatter plot with a title but without axis labels.
	 * @param title The title of the new scatter plot.
	 * @param xAxisLabel The label of the x-axis of the new scatter plot.
	 * @param yAxisLabel The label of the y-axis of the new scatter plot.
	 */
	 ...
	 * @param title The title of the current scatter plot.
	 */
	 ...
	 * @param title The x-axis label of the current scatter plot.
	 */
	 ...
	 * @param title The y-axis label of the current scatter plot.
	 */
	 ...
	 * @param newSeries The new data series to be added to the current scatter plot.
	 */
	 ...
	 * @param i The index of the data series to be deleted.
	 */
	 ...
	 * @param i The index of the data series to be returned.
	...
	/**
	 * Converts this graph to a Latex string representation. The Latex code uses the plugin {@code pgfplots}.
	 * @return The string that draws the current scatter plot in a Latex environment.
	 */
