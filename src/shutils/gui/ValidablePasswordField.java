...
public class ValidablePasswordField extends JPasswordField
{
	 ...
	 *
	 */
	private static final long serialVersionUID = -7193144087161640322L;
	/**
	...
	/**
	 * Updates the validation state of the component, checking the current password with the given validation function. After the check, the component is adequately formatted.
	 */
