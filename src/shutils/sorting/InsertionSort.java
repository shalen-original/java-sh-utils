...
public class InsertionSort {
	...
	/**
	 * Sorts an array using the Insertion Sort algorithm. Just as a remainder, we have that the best case complexity is {@code O(n)}, the
	 * average case complexity is {@code O(n^2)} and the worst case complexity is {@code O(n^2)}.
	 ...
	 * @param l The index of the leftmost element to sort.
	 * @param r The index of the rightmost element to sort.
	 */
