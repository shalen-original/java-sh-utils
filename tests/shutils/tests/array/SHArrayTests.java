...
public class SHArrayTests {
	...
	public void testFindMaxInRange_04() {
		...
		assertEquals(null, SHArray.findMaxInRange(A, 6, 2));
	}
	...
	public void testFindMaxInRange_05() {
		...
		assertEquals(null, SHArray.findMaxInRange(A, -1, 2));
	}
	...
	public void testFindMaxInRange_06() {
		...
		assertEquals(null, SHArray.findMaxInRange(A, 5, 6));
	}
	...
	public void testFindMaxInRange_07() {
		...
		assertEquals(null, SHArray.findMaxInRange(A, 1, -1));
	}
